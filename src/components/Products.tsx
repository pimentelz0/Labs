...
export const Products: React.FC<ProductsProps> = ({ onSelectProduct }) => {
  return (
    <section className="py-24 md:py-32 bg-[#000000]" id="products">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="max-w-3xl mb-16 md:mb-24">
          ...
          <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-white mb-6">
            Forjado para simplificar operações modernas
          </h2>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="mt-16 p-6 border border-white/[0.04] bg-[#1e293b]/50 backdrop-blur-md rounded-lg text-center font-mono text-xs text-slate-500"
        >
