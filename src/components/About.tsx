...
export const About: React.FC = () => {
  return (
    <section className="py-24 md:py-32 bg-[#000000] border-y border-white/[0.03]" id="about">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 items-start">
          ...
          <div className="lg:col-span-7 space-y-6 md:space-y-8 lg:pt-8">
            ...
            >
              Na HEFESTUS, construímos tecnologias que funcionam de maneira invisível. Acreditamos que o software deve capacitar operadores diretamente, sem exigir especializações redundantes para configurar dashboards ou consolidar lançamentos fiscais.
            </motion.p>
            ...
            >
              Seja acompanhando fluxos financeiros com o <strong>Capitae</strong> ou escalando faturamento e estoques com o <strong>Capitae Business</strong>, nosso ecossistema resolve problemas reais. Evitamos excesso de cores chamativas, jargões fabricados ou layouts poluídos. Escrevemos código limpo focado em humanos.
            </motion.p>
