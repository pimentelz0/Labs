    ...
    <>
      <header
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
          scrolled
            ? 'bg-[#050e09]/80 backdrop-blur-md border-b border-white/[0.05] py-4'
            : 'bg-transparent py-6'
        }`}
        id="app-navbar"
      >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed inset-0 top-[72px] z-40 bg-[#050e09] border-t border-white/[0.05] p-6 md:hidden flex flex-col gap-6"
          >
